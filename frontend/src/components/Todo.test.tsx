...
it("renders text when completed=true", () => {
  ...
  const helloStyle: React.CSSProperties | undefined = hello.find("li").props().style;
  expect(helloStyle ? helloStyle.textDecoration : "").toEqual("line-through");
});
...
it("renders text when completed=false", () => {
  ...
  const helloStyle: React.CSSProperties | undefined = hello.find("li").props().style;
  expect(helloStyle ? helloStyle.textDecoration : "").toEqual("none");
});
